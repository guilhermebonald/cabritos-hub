...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      <body className="min-h-screen bg-[#FFFDF9] text-slate-800 antialiased selection:bg-amber-300 selection:text-slate-900 pb-[calc(5.5rem+env(safe-area-inset-bottom))] sm:pb-8">
        <DesktopHeader />
